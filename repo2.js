...
const repository = "whatsapp bot";
const imageUrl = "https://files.catbox.moe/u2atim.jpeg";
      ...
      const sentMessage = await zk.sendMessage(dest, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            mediaUrl: "whatsapp.com/channel/0029VbB4nox4Y9lqVl2X8n3m",
            sourceUrl: "whatsapp.com/channel/0029VbB4nox4Y9lqVl2X8n3m",
          },
        },
      });
      ...
      zk.ev.on("messages.upsert", async (update) => {
        ...
        if (
          ...
          if (responseText === "1") {
            ...
            await zk.sendMessage(dest, { text: "whatsapp.com/channel/0029VbB4nox4Y9lqVl2X8n3m" });
